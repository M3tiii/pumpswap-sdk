...
module.exports = __toCommonJS(buy_exports);
...
function fee(amount, basisPoints) {
  return ceilDiv(amount.mul(basisPoints), new import_bn.default(1e4));
}
...
function buyBaseInputInternal(base, slippage, baseReserve, quoteReserve, lpFeeBps, protocolFeeBps, coinCreatorFeeBps, coinCreator) {
  ...
  const coinCreatorFee = import_web32.PublicKey.default.equals(coinCreator) ? new import_bn2.default(0) : fee(quoteAmountIn, coinCreatorFeeBps);
...
function buyQuoteInputInternal(quote, slippage, baseReserve, quoteReserve, lpFeeBps, protocolFeeBps, coinCreatorFeeBps, coinCreator) {
  ...
  const totalFeeBps = lpFeeBps.add(protocolFeeBps).add(import_web32.PublicKey.default.equals(coinCreator) ? new import_bn2.default(0) : coinCreatorFeeBps);
