...
function fee(amount, basisPoints) {
  return ceilDiv(amount.mul(basisPoints), new import_bn3.default(1e4));
}
...
var PumpAmmInternalSdk = class {
  ...
  async createPoolInstructionsInternal(index, creator, baseMint, quoteMint, baseIn, quoteIn, userBaseTokenAccount = void 0, userQuoteTokenAccount = void 0) {
    ...
    return await this.withWsolAccounts(
      ...
      async () => {
        ...
        const instructions = [];
        const poolBaseTokenAccountPDA = getAssociatedTokenAddressSync2(
          baseMint,
          pool,
          true,
          baseTokenProgram
        ...
        const poolQuoteTokenAccountPDA = getAssociatedTokenAddressSync2(
          quoteMint,
          pool,
          true,
          quoteTokenProgram
  ...
  async getPoolBaseAndQuoteAmounts(pool) {
    ...
    const poolBaseAmount = new BN7(poolBaseTokenAccount.amount.toString());
    const poolQuoteAmount = new BN7(poolQuoteTokenAccount.amount.toString());
